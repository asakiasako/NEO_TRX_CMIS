...
class DenebApi:
    ...
    def Echo (self, data):
        ...
        self.check_response(apiResponse, DenebApi.Echo)
        self.add_api_exec_cb()
        return apiResponse

    def ControlTask (self, bRoutineSelect, bAction, aReserved):
        #Default header
        header=ArgHeader()
        header.Length = 16
        header.Command = 0x2
        ...
        # assert: (x >= 0 && x <= 5)
        command_array[10] = aReserved[0]>>0
        command_array[11] = aReserved[1]>>0
        command_array[12] = aReserved[2]>>0
        command_array[13] = aReserved[3]>>0
        ...
        apiResponse = {
             ...
             'aReserved' : [                          (response[5] & 0xFF),
                          (response[6] & 0xFF),
                          ],
        }
        self.check_response(apiResponse, DenebApi.ControlTask)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def ExceptionBacktrace (self, processorId, aReserved):
        ...
        self.check_response(apiResponse, DenebApi.ExceptionBacktrace)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def Hlupgrade (self, action):
        ...
        self.check_response(apiResponse, DenebApi.Hlupgrade)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetLineSymbolRate (self, ):
        ...
        self.check_response(apiResponse, DenebApi.GetLineSymbolRate)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def ReadRegister (self, address):
        ...
        self.check_response(apiResponse, DenebApi.ReadRegister)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def WriteRegister (self, address, value):
        ...
        self.check_response(apiResponse, DenebApi.WriteRegister)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def UpdateOneRegister (self, address, value, mask):
        ...
        self.check_response(apiResponse, DenebApi.UpdateOneRegister)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def ReadFirmwareInformation (self, ):
        ...
        apiResponse = {
             ...
             'aRm' : [                          (response[68] & 0xFF),
                          (response[69] & 0xFF),
                          (response[70] & 0xFF),
                          (response[71] & 0xFF),
                          ],
             'aDate' : [                          (response[72] & 0xFF),
                          (response[73] & 0xFF),
                          (response[74] & 0xFF),
                          (response[75] & 0xFF),
                          (response[76] & 0xFF),
             ...
             'bReserved' : (response[78] & 0xFF),
        }
        self.check_response(apiResponse, DenebApi.ReadFirmwareInformation)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetGpioMap (self, gpio_id):
        ...
        self.check_response(apiResponse, DenebApi.GetGpioMap)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetGpioMap (self, register_addr, gpio_id, bit_number, gpio_direction):
        ...
        self.check_response(apiResponse, DenebApi.SetGpioMap)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetGpio (self, gpio_id):
        ...
        self.check_response(apiResponse, DenebApi.GetGpio)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetGpio (self, gpio_id, gpio_direction, gpio_status):
        ...
        self.check_response(apiResponse, DenebApi.SetGpio)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetChipId (self, ):
        ...
        self.check_response(apiResponse, DenebApi.GetChipId)
        self.add_api_exec_cb()
        return apiResponse

    def GetCanopusCfecCompatibilityMode (self, ):
        #Default header
        header=ArgHeader()
        header.Length = 8
        ...
        self.check_response(apiResponse, DenebApi.GetCanopusCfecCompatibilityMode)
        self.add_api_exec_cb()
        return apiResponse

    def SetCanopusCfecCompatibilityMode (self, enable):
        #Default header
        header=ArgHeader()
        header.Length = 12
        header.Command = 0x265
        header.Tag = 0
        header.MaxResponse = 4
        header.Reserved = 0
        ...
        self.check_response(apiResponse, DenebApi.SetCanopusCfecCompatibilityMode)
        self.add_api_exec_cb()
        return apiResponse

    def SetTransceiverMode (self, reserved_0, line_fec, line_modulation, bcd_mode, ltx_osr, lrx_osr, reserved_1, signal_type, line_mapping, host_modulation):
        #Default header
        header=ArgHeader()
        header.Length = 32
        ...
        command_array[12] = bcd_mode>>8
        command_array[13] = bcd_mode>>16
        command_array[14] = bcd_mode>>24
        command_array[15] = ltx_osr>>0
        # assert: (x >= 0 && x <= 4)
        command_array[16] = lrx_osr>>0
        # assert: (x >= 0 && x <= 4)
        command_array[17] = reserved_1>>0
        command_array[18] = reserved_1>>8
        command_array[19] = reserved_1>>16
        command_array[20] = reserved_1>>24
        command_array[21] = signal_type[0]>>0
        # assert: (x >= 0 && x <= 7)
        command_array[22] = signal_type[1]>>0
        # assert: (x >= 0 && x <= 7)
        command_array[23] = signal_type[2]>>0
        # assert: (x >= 0 && x <= 7)
        command_array[24] = signal_type[3]>>0
        # assert: (x >= 0 && x <= 7)
        command_array[25] = line_mapping[0]>>0
        # assert: (x >= 0 && x <= 7) || (x == 16)
        command_array[26] = line_mapping[1]>>0
        # assert: (x >= 0 && x <= 7) || (x == 16)
        command_array[27] = line_mapping[2]>>0
        # assert: (x >= 0 && x <= 7) || (x == 16)
        command_array[28] = line_mapping[3]>>0
        # assert: (x >= 0 && x <= 7) || (x == 16)
        command_array[29] = host_modulation>>0
        # assert: (x >= 0 && x <= 1)
        ...
        self.check_response(apiResponse, DenebApi.SetTransceiverMode)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetLoopbackMode (self, lpbk_mode, channel, enable):
        ...
        self.check_response(apiResponse, DenebApi.SetLoopbackMode)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetLoopbackMode (self, lpbk_mode, channel):
        ...
        self.check_response(apiResponse, DenebApi.GetLoopbackMode)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetHostBallMap (self, hrx_mapping, htx_mapping):
        ...
        self.check_response(apiResponse, DenebApi.SetHostBallMap)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetHostDynamicReprovisioning (self, channel, signal_type):
        ...
        self.check_response(apiResponse, DenebApi.SetHostDynamicReprovisioning)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetTransceiverMode (self, ):
        ...
        apiResponse = {
             ...
             'line_modulation' : (response[5] & 0xFF),
             'line_symbol_rate' : (response[6] & 0xFF)|((response[7]<<8) & (0xFF<<8))|((response[8]<<16) & (0xFF<<16))|((response[9]<<24) & (0xFF<<24)),
             'bcd_mode' : (response[10] & 0xFF)|((response[11]<<8) & (0xFF<<8))|((response[12]<<16) & (0xFF<<16))|((response[13]<<24) & (0xFF<<24)),
             'ltx_osr' : (response[14] & 0xFF),
             'lrx_osr' : (response[15] & 0xFF),
             'reserved_0' : (response[16] & 0xFF)|((response[17]<<8) & (0xFF<<8))|((response[18]<<16) & (0xFF<<16))|((response[19]<<24) & (0xFF<<24)),
             'signal_type' : [                          (response[20] & 0xFF),
                          (response[21] & 0xFF),
                          (response[22] & 0xFF),
                          (response[23] & 0xFF),
                          ],
             'line_mapping' : [                          (response[24] & 0xFF),
                          (response[25] & 0xFF),
                          (response[26] & 0xFF),
                          (response[27] & 0xFF),
                          ],
             'host_modulation' : (response[28] & 0xFF),
        }
        self.check_response(apiResponse, DenebApi.GetTransceiverMode)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetHostBallMap (self, ):
        ...
        self.check_response(apiResponse, DenebApi.GetHostBallMap)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOpticalMonitorTriggerSource (self, trigger_source, interval):
        ...
        self.check_response(apiResponse, DenebApi.SetOpticalMonitorTriggerSource)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetPerformanceMonitorTriggerSource (self, trigger_source):
        ...
        self.check_response(apiResponse, DenebApi.SetPerformanceMonitorTriggerSource)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOpticalMonitorTriggerSource (self, ):
        ...
        self.check_response(apiResponse, DenebApi.GetOpticalMonitorTriggerSource)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetPerformanceMonitorTriggerSource (self, ):
        ...
        self.check_response(apiResponse, DenebApi.GetPerformanceMonitorTriggerSource)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def TriggerMonitors (self, ):
        ...
        self.check_response(apiResponse, DenebApi.TriggerMonitors)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetPcsMode (self, channel, mode):
        ...
        self.check_response(apiResponse, DenebApi.SetPcsMode)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetPcsMode (self, channel):
        ...
        self.check_response(apiResponse, DenebApi.GetPcsMode)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def ReStartLineIngressDsp (self, action):
        ...
        self.check_response(apiResponse, DenebApi.ReStartLineIngressDsp)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetFlexOMaintenanceSignalConfig (self, channel):
        ...
        self.check_response(apiResponse, DenebApi.GetFlexOMaintenanceSignalConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetFlexOMaintenanceSignalConfig (self, channel, maintenance_signal):
        ...
        self.check_response(apiResponse, DenebApi.SetFlexOMaintenanceSignalConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnMaintenanceSignalConfig (self, channel):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnMaintenanceSignalConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOtnMaintenanceSignalConfig (self, channel, maintenance_signal):
        ...
        self.check_response(apiResponse, DenebApi.SetOtnMaintenanceSignalConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetClientSwap (self, direction, clients):
        ...
        self.check_response(apiResponse, DenebApi.SetClientSwap)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetClientSwap (self, direction):
        ...
        self.check_response(apiResponse, DenebApi.GetClientSwap)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetEthernetFec (self, channel, bypass_correction_enable, bypass_indication_enable):
        ...
        self.check_response(apiResponse, DenebApi.SetEthernetFec)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetEthernetFec (self, channel):
        ...
        self.check_response(apiResponse, DenebApi.GetEthernetFec)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOtnOhpHardwareAlarmsInterfacesConfig (self, channel, map_level, hardware_pin_select, ddeg_bus, dtim_bus, diae_bus, dbiae_bus, dbdi_bus, dltc_bus, dais_bus, doci_bus, dlck_bus, dmsim, dplm, dcsf):
        ...
        self.check_response(apiResponse, DenebApi.SetOtnOhpHardwareAlarmsInterfacesConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnOhpHardwareAlarmsInterfacesConfig (self, channel, map_level, hardware_pin_select):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnOhpHardwareAlarmsInterfacesConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOtnHardwareAlarmsInterfacesConfig (self, channel, direction, hardware_pin_select, otu_dloflane, otu_dlol, otu_dlof, otu_dlom):
        ...
        self.check_response(apiResponse, DenebApi.SetOtnHardwareAlarmsInterfacesConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnHardwareAlarmsInterfacesConfig (self, channel, direction, hardware_pin_select):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnHardwareAlarmsInterfacesConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOtnGmpHardwareAlarmsInterfacesConfig (self, channel, hardware_pin_select, odu_map1_dloflom, odu_map2_dloflom, gmp_host_dloomfi, gmp_map1_dloomfi, gmp_map2_dloomfi):
        ...
        self.check_response(apiResponse, DenebApi.SetOtnGmpHardwareAlarmsInterfacesConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnGmpHardwareAlarmsInterfacesConfig (self, channel, hardware_pin_select):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnGmpHardwareAlarmsInterfacesConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetEthernetHardwareAlarmsInterfacesConfig (self, channel, direction, hardware_pin_select, pcs_align_status_n, pcs_lf_detected, pcs_rf_detected, pcs_hi_ber, pcs_hi_ser, pcs257_am_lock_n, pcs66_block_lock_n, pcs66_am_lock_n):
        ...
        self.check_response(apiResponse, DenebApi.SetEthernetHardwareAlarmsInterfacesConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetEthernetHardwareAlarmsInterfacesConfig (self, channel, direction, hardware_pin_select):
        ...
        self.check_response(apiResponse, DenebApi.GetEthernetHardwareAlarmsInterfacesConfig)
        self.add_api_exec_cb()
        return apiResponse

    def GetFlexOHardwareAlarmsInterfacesConfig (self, direction, channel, hardware_pin_select):
        #Default header
        header=ArgHeader()
        header.Length = 12
        ...
        self.check_response(apiResponse, DenebApi.GetFlexOHardwareAlarmsInterfacesConfig)
        self.add_api_exec_cb()
        return apiResponse

    def SetFlexOHardwareAlarmsInterfacesConfig (self, direction, channel, hardware_pin_select, flexo_dlol, flexo_dlom, flexo_dloflom, flexo_drdi, flexo_dgidm, flexo_dpmm):
        #Default header
        header=ArgHeader()
        header.Length = 20
        ...
        command_array[10] = hardware_pin_select>>0
        # assert: (x >= 0 && x <= 2)
        command_array[11] = flexo_dlol>>0
        # assert: (x >= 0 && x <= 1)
        command_array[12] = flexo_dlom>>0
        # assert: (x >= 0 && x <= 1)
        command_array[13] = flexo_dloflom>>0
        # assert: (x >= 0 && x <= 1)
        command_array[14] = flexo_drdi>>0
        # assert: (x >= 0 && x <= 1)
        command_array[15] = flexo_dgidm>>0
        # assert: (x >= 0 && x <= 1)
        command_array[16] = flexo_dpmm>>0
        # assert: (x >= 0 && x <= 1)
        ...
        self.check_response(apiResponse, DenebApi.SetFlexOHardwareAlarmsInterfacesConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetFlexEHardwareAlarmsInterfacesConfig (self, channel, direction, hardware_pin_select):
        ...
        self.check_response(apiResponse, DenebApi.GetFlexEHardwareAlarmsInterfacesConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetFlexEHardwareAlarmsInterfacesConfig (self, channel, direction, hardware_pin_select, flexe_drdi, flexe_dgidm, flexe_dpmm, flexe_dlof, flexe_dlom):
        ...
        self.check_response(apiResponse, DenebApi.SetFlexEHardwareAlarmsInterfacesConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetGmpConsequentActionConfig (self, channel, map_level, gmp_dloomfi_ca_enable, ohp_dplm_ca_enable):
        ...
        self.check_response(apiResponse, DenebApi.SetGmpConsequentActionConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetGmpConsequentActionConfig (self, channel, map_level):
        ...
        self.check_response(apiResponse, DenebApi.GetGmpConsequentActionConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetEthernetConsequentActionsConfig (self, channel, direction, pcs_lf_detected_ca_enable, pcs_rf_detected_ca_enable, pcs_hi_ber_ca_enable, pcs_hi_ser_ca_enable):
        ...
        self.check_response(apiResponse, DenebApi.SetEthernetConsequentActionsConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetEthernetConsequentActionsConfig (self, channel, direction):
        ...
        self.check_response(apiResponse, DenebApi.GetEthernetConsequentActionsConfig)
        self.add_api_exec_cb()
        return apiResponse

    def SetFlexOConsequentActionsConfig (self, direction, channel, flexo_drdi_ca_enable, flexo_dgidm_ca_enable, flexo_dpmm_ca_enable):
        #Default header
        header=ArgHeader()
        header.Length = 16
        ...
        command_array[9] = channel>>0
        # assert: (x >= 0 && x <= 3)
        command_array[10] = flexo_drdi_ca_enable>>0
        # assert: (x >= 0 && x <= 1)
        command_array[11] = flexo_dgidm_ca_enable>>0
        # assert: (x >= 0 && x <= 1)
        command_array[12] = flexo_dpmm_ca_enable>>0
        # assert: (x >= 0 && x <= 1)
        ...
        self.check_response(apiResponse, DenebApi.SetFlexOConsequentActionsConfig)
        self.add_api_exec_cb()
        return apiResponse

    def GetFlexOConsequentActionsConfig (self, direction, channel):
        #Default header
        header=ArgHeader()
        header.Length = 12
        ...
        self.check_response(apiResponse, DenebApi.GetFlexOConsequentActionsConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetEnableConsequentActions (self, channel, direction, ca_enable):
        ...
        self.check_response(apiResponse, DenebApi.SetEnableConsequentActions)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetEnableConsequentActions (self, channel, direction):
        ...
        self.check_response(apiResponse, DenebApi.GetEnableConsequentActions)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetEthernetMaintenanceSignalConfig (self, channel, egress_maintenance_signal, ingress_maintenance_signal):
        ...
        self.check_response(apiResponse, DenebApi.SetEthernetMaintenanceSignalConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetEthernetMaintenanceSignalConfig (self, channel):
        ...
        self.check_response(apiResponse, DenebApi.GetEthernetMaintenanceSignalConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnOhpPmCounters (self, channel, map_level, layer_level):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnOhpPmCounters)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetFlexoGroupConfig (self, channel_sync):
        ...
        self.check_response(apiResponse, DenebApi.SetFlexoGroupConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetFlexoGroupConfig (self, ):
        ...
        self.check_response(apiResponse, DenebApi.GetFlexoGroupConfig)
        self.add_api_exec_cb()
        return apiResponse

    def GetFlexOOhpSinkFieldsAccepted (self, direction, channel):
        #Default header
        header=ArgHeader()
        header.Length = 12
        ...
        self.check_response(apiResponse, DenebApi.GetFlexOOhpSinkFieldsAccepted)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetPcsFramePauseConfig (self, frame_pause_source_address, frame_pause_destination_address, frame_pause_enable, frame_pause_time_override_enable, frame_pause_time_override_value, frame_pause_gap_override_enable, frame_pause_gap_override_value):
        ...
        self.check_response(apiResponse, DenebApi.SetPcsFramePauseConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetPcsFramePauseConfig (self, ):
        ...
        self.check_response(apiResponse, DenebApi.GetPcsFramePauseConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOverrideDefaultConfig (self, param_index, value):
        ...
        self.check_response(apiResponse, DenebApi.SetOverrideDefaultConfig)
        self.add_api_exec_cb()
        return apiResponse

    def GetLineEgressLaneAnalogAttenuation (self, lane):
        #Default header
        header=ArgHeader()
        header.Length = 12
        ...
        apiResponse = {
             ...
             'Status' : (response[2] & 0xFF),
             'Info' : (response[3] & 0xFF),
             'attenuation' : (response[4] & 0xFF),
        }
        self.check_response(apiResponse, DenebApi.GetLineEgressLaneAnalogAttenuation)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetLineEgressLaneAnalogAttenuation (self, lane, attenuation):
        ...
        self.check_response(apiResponse, DenebApi.SetLineEgressLaneAnalogAttenuation)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetLineEgressLowSrLaneAttenuation (self, lane):
        ...
        self.check_response(apiResponse, DenebApi.GetLineEgressLowSrLaneAttenuation)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetLineEgressLowSrLaneAttenuation (self, lane, attenuation):
        ...
        self.check_response(apiResponse, DenebApi.SetLineEgressLowSrLaneAttenuation)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetLineEgressLowSrFilterCoefficients (self, lane, coefficients):
        ...
        self.check_response(apiResponse, DenebApi.SetLineEgressLowSrFilterCoefficients)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetLineEgressLowSrFilterCoefficients (self, lane):
        ...
        self.check_response(apiResponse, DenebApi.GetLineEgressLowSrFilterCoefficients)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetLineEgressLowSrLaneSkew (self, lane, skew, reserved):
        ...
        self.check_response(apiResponse, DenebApi.SetLineEgressLowSrLaneSkew)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetLineEgressLowSrLaneSkew (self, lane):
        ...
        self.check_response(apiResponse, DenebApi.GetLineEgressLowSrLaneSkew)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetLineEgressHighSrFilterCoefficients (self, lane, coefficients):
        ...
        self.check_response(apiResponse, DenebApi.SetLineEgressHighSrFilterCoefficients)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetLineEgressHighSrFilterCoefficients (self, lane):
        ...
        self.check_response(apiResponse, DenebApi.GetLineEgressHighSrFilterCoefficients)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetLineEgressHighSrLaneSkew (self, lane):
        ...
        self.check_response(apiResponse, DenebApi.GetLineEgressHighSrLaneSkew)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetLineEgressHighSrLaneSkew (self, lane, skew):
        ...
        self.check_response(apiResponse, DenebApi.SetLineEgressHighSrLaneSkew)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetLineEgressHighSrPulseShaping (self, lane, roll_off_factor, pulse_shaping_filter):
        ...
        self.check_response(apiResponse, DenebApi.SetLineEgressHighSrPulseShaping)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetLineEgressHighSrPreEmphasis (self, lane, coefficients, enable):
        ...
        self.check_response(apiResponse, DenebApi.SetLineEgressHighSrPreEmphasis)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetLineEgressHighSrLaneAmplitude (self, lane, amplitude):
        ...
        self.check_response(apiResponse, DenebApi.SetLineEgressHighSrLaneAmplitude)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetLineEgressHighSrLaneAmplitude (self, lane):
        ...
        self.check_response(apiResponse, DenebApi.GetLineEgressHighSrLaneAmplitude)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetLineEgressLaneReassignment (self, lane_0, lane_1, lane_2, lane_3):
        ...
        self.check_response(apiResponse, DenebApi.SetLineEgressLaneReassignment)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetLineEgressLaneReassignment (self, ):
        ...
        self.check_response(apiResponse, DenebApi.GetLineEgressLaneReassignment)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetLineEgressHighSrPulseShaping (self, lane):
        ...
        self.check_response(apiResponse, DenebApi.GetLineEgressHighSrPulseShaping)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetLineEgressHighSrPreEmphasis (self, lane):
        ...
        self.check_response(apiResponse, DenebApi.GetLineEgressHighSrPreEmphasis)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetLineEgressLaneMute (self, lane, mute):
        ...
        self.check_response(apiResponse, DenebApi.SetLineEgressLaneMute)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetLineEgressLaneMute (self, lane):
        ...
        self.check_response(apiResponse, DenebApi.GetLineEgressLaneMute)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetLineEgressLanePolarity (self, lane, polarity):
        ...
        self.check_response(apiResponse, DenebApi.SetLineEgressLanePolarity)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetLineEgressLanePolarity (self, lane):
        ...
        self.check_response(apiResponse, DenebApi.GetLineEgressLanePolarity)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetLineEgressHighSrFrequencyMaskBoost (self, lane, frequency_bin, gain, frequency_mask_width):
        ...
        self.check_response(apiResponse, DenebApi.SetLineEgressHighSrFrequencyMaskBoost)
        self.add_api_exec_cb()
        return apiResponse

    def GetIngressSmState (self, ):
        #Default header
        header=ArgHeader()
        header.Length = 8
        header.Command = 0x261
        header.Tag = 0
        header.MaxResponse = 8
        header.Reserved = 0
        ...
        apiResponse = {
             ...
             'Status' : (response[2] & 0xFF),
             'Info' : (response[3] & 0xFF),
             'state' : (response[4] & 0xFF),
        }
        self.check_response(apiResponse, DenebApi.GetIngressSmState)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetLineIngressDspStatus (self, ):
        ...
        self.check_response(apiResponse, DenebApi.GetLineIngressDspStatus)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetLineIngressCcrBypass (self, enable):
        ...
        self.check_response(apiResponse, DenebApi.SetLineIngressCcrBypass)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetLineIngressCcrBypass (self, ):
        ...
        self.check_response(apiResponse, DenebApi.GetLineIngressCcrBypass)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetLineIngressSkew (self, polarization, skew_phase_i):
        ...
        self.check_response(apiResponse, DenebApi.SetLineIngressSkew)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetLineIngressSkew (self, polarization):
        ...
        self.check_response(apiResponse, DenebApi.GetLineIngressSkew)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetLineIngressMatrixRotator (self, coefficients, mtr_mode, bypass):
        ...
        self.check_response(apiResponse, DenebApi.SetLineIngressMatrixRotator)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetLineIngressMatrixRotator (self, ):
        ...
        self.check_response(apiResponse, DenebApi.GetLineIngressMatrixRotator)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetLineIngressFleCdRange (self, min_cd, max_cd):
        ...
        self.check_response(apiResponse, DenebApi.SetLineIngressFleCdRange)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetLineIngressBcdFilter (self, ):
        ...
        self.check_response(apiResponse, DenebApi.GetLineIngressBcdFilter)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetLineIngressBcdFilter (self, roll_off_factor, pulse_shaping_filter):
        ...
        self.check_response(apiResponse, DenebApi.SetLineIngressBcdFilter)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetLineIngressBps (self, window_h, window_v, bypass):
        ...
        self.check_response(apiResponse, DenebApi.SetLineIngressBps)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetLineIngressBps (self, ):
        ...
        self.check_response(apiResponse, DenebApi.GetLineIngressBps)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetLineIngressAgcStatus (self, ):
        ...
        self.check_response(apiResponse, DenebApi.GetLineIngressAgcStatus)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetLineIngressAgcConfig (self, lane, signal_reference, signal_gain, signal_max, signal_min, enable):
        ...
        self.check_response(apiResponse, DenebApi.SetLineIngressAgcConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetLineIngressAgcConfig (self, lane):
        ...
        self.check_response(apiResponse, DenebApi.GetLineIngressAgcConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetLineIngressLosConfig (self, lane, signal_detect_dn, signal_detect_up, signal_detect_high, mode, enable):
        ...
        self.check_response(apiResponse, DenebApi.SetLineIngressLosConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetLineIngressLosConfig (self, lane):
        ...
        self.check_response(apiResponse, DenebApi.GetLineIngressLosConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetLineIngressFleCdRange (self, ):
        ...
        self.check_response(apiResponse, DenebApi.GetLineIngressFleCdRange)
        self.add_api_exec_cb()
        return apiResponse

    def GetHostFastRelockMode (self, ):
        #Default header
        header=ArgHeader()
        header.Length = 8
        header.Command = 0x29E
        header.Tag = 0
        header.MaxResponse = 8
        header.Reserved = 0
        ...
        apiResponse = {
             ...
             'Status' : (response[2] & 0xFF),
             'Info' : (response[3] & 0xFF),
             'fast_relock_mode' : (response[4] & 0xFF),
             'fast_relock_enabled' : (response[5] & 0xFF),
        }
        self.check_response(apiResponse, DenebApi.GetHostFastRelockMode)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetHostEgressLanePolarity (self, ):
        ...
        self.check_response(apiResponse, DenebApi.GetHostEgressLanePolarity)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetHostEgressLanePolarity (self, polarity):
        ...
        self.check_response(apiResponse, DenebApi.SetHostEgressLanePolarity)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetHostHistogram (self, lane):
        ...
        self.check_response(apiResponse, DenebApi.GetHostHistogram)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def RelinkHostEgress (self, lane):
        ...
        self.check_response(apiResponse, DenebApi.RelinkHostEgress)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetHostRxStatus (self, lane):
        ...
        apiResponse = {
             ...
             'cstune' : (response[6] & 0xFF),
             'rstune' : (response[7] & 0xFF),
             'term_att' : (response[8] & 0xFF),
             'vga_gain1' : (response[9] & 0xFF)|((response[10]<<8) & (0xFF<<8)),
             'vga_gain2' : (response[11] & 0xFF)|((response[12]<<8) & (0xFF<<8)),
        }
        self.check_response(apiResponse, DenebApi.GetHostRxStatus)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetHostPulseResponse (self, lane):
        ...
        self.check_response(apiResponse, DenebApi.GetHostPulseResponse)
        self.add_api_exec_cb()
        return apiResponse

    def SetHostFastRelockMode (self, fast_relock_mode):
        #Default header
        header=ArgHeader()
        header.Length = 12
        header.Command = 0x299
        header.Tag = 0
        header.MaxResponse = 4
        header.Reserved = 0
        ...
        command_array[6] = header.Tag>>0
        command_array[7] = header.Reserved>>0
        command_array[8] = fast_relock_mode>>0
        # assert: (x >= 0 && x <= 2)
    ...
    def GetHostIngressLanePolarity (self, ):
        ...
        self.check_response(apiResponse, DenebApi.GetHostIngressLanePolarity)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetHostIngressLanePolarity (self, polarity):
        ...
        self.check_response(apiResponse, DenebApi.SetHostIngressLanePolarity)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetHostIngressLaneMute (self, dual, mute):
        ...
        self.check_response(apiResponse, DenebApi.SetHostIngressLaneMute)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetHostIngressLaneMute (self, dual):
        ...
        self.check_response(apiResponse, DenebApi.GetHostIngressLaneMute)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetHostIngressFilterCoefficients (self, lane, coefficients, low_eye, high_eye):
        ...
        self.check_response(apiResponse, DenebApi.SetHostIngressFilterCoefficients)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetHostIngressFilterCoefficients (self, lane):
        ...
        self.check_response(apiResponse, DenebApi.GetHostIngressFilterCoefficients)
        self.add_api_exec_cb()
        return apiResponse

    def SetZrOhpMsiConfig (self, channel, msi_byte):
        #Default header
        header=ArgHeader()
        header.Length = 12
        header.Command = 0x144
        header.Tag = 0
        header.MaxResponse = 4
        header.Reserved = 0
        ...
        self.check_response(apiResponse, DenebApi.SetZrOhpMsiConfig)
        self.add_api_exec_cb()
        return apiResponse

    def GetZrOhpMsiConfig (self, channel):
        #Default header
        header=ArgHeader()
        header.Length = 12
        header.Command = 0x143
        header.Tag = 0
        header.MaxResponse = 8
        header.Reserved = 0
        ...
        apiResponse = {
             ...
             'Status' : (response[2] & 0xFF),
             'Info' : (response[3] & 0xFF),
             'msi_byte' : (response[4] & 0xFF),
        }
        self.check_response(apiResponse, DenebApi.GetZrOhpMsiConfig)
        self.add_api_exec_cb()
        return apiResponse

    def GetZrOhpMsiAccepted (self, channel):
        #Default header
        header=ArgHeader()
        header.Length = 12
        header.Command = 0x142
        header.Tag = 0
        header.MaxResponse = 8
        header.Reserved = 0
        ...
        self.check_response(apiResponse, DenebApi.GetZrOhpMsiAccepted)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetPcsMlgAlignmentMarkers (self, channel):
        ...
        self.check_response(apiResponse, DenebApi.GetPcsMlgAlignmentMarkers)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetPcsMlgAlignmentMarkers (self, channel, lane_marker):
        ...
        self.check_response(apiResponse, DenebApi.SetPcsMlgAlignmentMarkers)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOtnOhpSourceStat (self, channel, map_level, layer_level, mode, override_enable, override_value):
        ...
        self.check_response(apiResponse, DenebApi.SetOtnOhpSourceStat)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOtnOhpSourceBip8 (self, channel, map_level, layer_level, mode):
        ...
        self.check_response(apiResponse, DenebApi.SetOtnOhpSourceBip8)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOtnOhpSourceBeiBiae (self, channel, map_level, layer_level, mode, override_enable, override_value):
        ...
        self.check_response(apiResponse, DenebApi.SetOtnOhpSourceBeiBiae)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOtnOhpSourceBdi (self, channel, map_level, layer_level, mode, override_enable, override_value):
        ...
        self.check_response(apiResponse, DenebApi.SetOtnOhpSourceBdi)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOtnOhpSinkFtflAcceptedMask (self, channel, map_level, ftfl_mask):
        ...
        self.check_response(apiResponse, DenebApi.SetOtnOhpSinkFtflAcceptedMask)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnOhpSourceStat (self, channel, map_level, layer_level):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnOhpSourceStat)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnOhpSourceBip8 (self, channel, map_level, layer_level):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnOhpSourceBip8)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnOhpSourceBeiBiae (self, channel, map_level, layer_level):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnOhpSourceBeiBiae)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnOhpSourceBdi (self, channel, map_level, layer_level):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnOhpSourceBdi)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnOhpSinkFtflAcceptedMask (self, channel, map_level):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnOhpSinkFtflAcceptedMask)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOtnOhpSourcePt (self, channel, map_level, payload_type_value, payload_type_enable):
        ...
        self.check_response(apiResponse, DenebApi.SetOtnOhpSourcePt)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnOhpSourcePt (self, channel, map_level):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnOhpSourcePt)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOtnOhpSinkDdegThreshold (self, channel, map_level, layer_level, degraded_threshold, accum_good_seconds, accum_bad_seconds):
        ...
        self.check_response(apiResponse, DenebApi.SetOtnOhpSinkDdegThreshold)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnOhpSinkDdegThreshold (self, channel, map_level, layer_level):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnOhpSinkDdegThreshold)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOtnOhpSourceFtfl (self, channel, map_level, ftfl_value, ftfl_enable):
        ...
        self.check_response(apiResponse, DenebApi.SetOtnOhpSourceFtfl)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnOhpSourceFtfl (self, channel, map_level):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnOhpSourceFtfl)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOtnOhpLayerReorder (self, channel, map_level, layer_level_reorder_array):
        ...
        self.check_response(apiResponse, DenebApi.SetOtnOhpLayerReorder)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnOhpLayerReorder (self, channel, map_level):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnOhpLayerReorder)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOtnOhpSinkMode (self, channel, map_level, layer_level, layer_mode, tim_action_enable, ltc_action_enable):
        ...
        self.check_response(apiResponse, DenebApi.SetOtnOhpSinkMode)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnOhpSinkMode (self, channel, map_level, layer_level):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnOhpSinkMode)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOtnOhpDmMode (self, channel, map_level, dm_subfield, dm_mode):
        ...
        self.check_response(apiResponse, DenebApi.SetOtnOhpDmMode)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnOhpDmMode (self, channel, map_level, dm_subfield):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnOhpDmMode)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def RunOtnOhpDm (self, channel, map_level, dm_subfield, dm_action):
        ...
        self.check_response(apiResponse, DenebApi.RunOtnOhpDm)
        self.add_api_exec_cb()
        return apiResponse

    def SetFlexOOhpSourceMode (self, direction, channel, phy_map_value, gid_value, pid_value, avail_value):
        #Default header
        header=ArgHeader()
        header.Length = 48
        ...
        command_array[9] = channel>>0
        # assert: (x >= 0 && x <= 3)
        command_array[10] = phy_map_value[0]>>0
        command_array[11] = phy_map_value[0]>>8
        command_array[12] = phy_map_value[0]>>16
        command_array[13] = phy_map_value[0]>>24
        command_array[14] = phy_map_value[1]>>0
        command_array[15] = phy_map_value[1]>>8
        command_array[16] = phy_map_value[1]>>16
        command_array[17] = phy_map_value[1]>>24
        command_array[18] = phy_map_value[2]>>0
        command_array[19] = phy_map_value[2]>>8
        command_array[20] = phy_map_value[2]>>16
        command_array[21] = phy_map_value[2]>>24
        command_array[22] = phy_map_value[3]>>0
        command_array[23] = phy_map_value[3]>>8
        command_array[24] = phy_map_value[3]>>16
        command_array[25] = phy_map_value[3]>>24
        command_array[26] = phy_map_value[4]>>0
        command_array[27] = phy_map_value[4]>>8
        command_array[28] = phy_map_value[4]>>16
        command_array[29] = phy_map_value[4]>>24
        command_array[30] = phy_map_value[5]>>0
        command_array[31] = phy_map_value[5]>>8
        command_array[32] = phy_map_value[5]>>16
        command_array[33] = phy_map_value[5]>>24
        command_array[34] = phy_map_value[6]>>0
        command_array[35] = phy_map_value[6]>>8
        command_array[36] = phy_map_value[6]>>16
        command_array[37] = phy_map_value[6]>>24
        command_array[38] = phy_map_value[7]>>0
        command_array[39] = phy_map_value[7]>>8
        command_array[40] = phy_map_value[7]>>16
        command_array[41] = phy_map_value[7]>>24
        command_array[42] = gid_value>>0
        command_array[43] = gid_value>>8
        command_array[44] = gid_value>>16
        command_array[45] = gid_value>>24
        # assert: (x < 0xFFFFF)
        command_array[46] = pid_value>>0
        command_array[47] = avail_value>>0
        ...
        self.check_response(apiResponse, DenebApi.SetFlexOOhpSourceMode)
        self.add_api_exec_cb()
        return apiResponse

    def GetFlexOOhpSourceMode (self, direction, channel):
        #Default header
        header=ArgHeader()
        header.Length = 12
        ...
        self.check_response(apiResponse, DenebApi.GetFlexOOhpSourceMode)
        self.add_api_exec_cb()
        return apiResponse

    def SetFlexOOhpSinkFieldsExpected (self, direction, channel, phy_map_expected, gid_expected, pid_expected):
        #Default header
        header=ArgHeader()
        header.Length = 48
        ...
        command_array[11] = phy_map_expected[0]>>8
        command_array[12] = phy_map_expected[0]>>16
        command_array[13] = phy_map_expected[0]>>24
        command_array[14] = phy_map_expected[1]>>0
        command_array[15] = phy_map_expected[1]>>8
        command_array[16] = phy_map_expected[1]>>16
        command_array[17] = phy_map_expected[1]>>24
        command_array[18] = phy_map_expected[2]>>0
        command_array[19] = phy_map_expected[2]>>8
        command_array[20] = phy_map_expected[2]>>16
        command_array[21] = phy_map_expected[2]>>24
        command_array[22] = phy_map_expected[3]>>0
        command_array[23] = phy_map_expected[3]>>8
        command_array[24] = phy_map_expected[3]>>16
        command_array[25] = phy_map_expected[3]>>24
        command_array[26] = phy_map_expected[4]>>0
        command_array[27] = phy_map_expected[4]>>8
        command_array[28] = phy_map_expected[4]>>16
        command_array[29] = phy_map_expected[4]>>24
        command_array[30] = phy_map_expected[5]>>0
        command_array[31] = phy_map_expected[5]>>8
        command_array[32] = phy_map_expected[5]>>16
        command_array[33] = phy_map_expected[5]>>24
        command_array[34] = phy_map_expected[6]>>0
        command_array[35] = phy_map_expected[6]>>8
        command_array[36] = phy_map_expected[6]>>16
        command_array[37] = phy_map_expected[6]>>24
        command_array[38] = phy_map_expected[7]>>0
        command_array[39] = phy_map_expected[7]>>8
        command_array[40] = phy_map_expected[7]>>16
        command_array[41] = phy_map_expected[7]>>24
        ...
        self.check_response(apiResponse, DenebApi.SetFlexOOhpSinkFieldsExpected)
        self.add_api_exec_cb()
        return apiResponse

    def GetFlexOOhpSinkFieldsExpected (self, direction, channel):
        #Default header
        header=ArgHeader()
        header.Length = 12
        ...
        self.check_response(apiResponse, DenebApi.GetFlexOOhpSinkFieldsExpected)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetFlexEOhpSinkFieldsExpected (self, channel, direction, phy_map_expected, gid_expected, pid_expected):
        ...
        self.check_response(apiResponse, DenebApi.SetFlexEOhpSinkFieldsExpected)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetFlexEOhpSinkFieldsExpected (self, channel, direction):
        ...
        self.check_response(apiResponse, DenebApi.GetFlexEOhpSinkFieldsExpected)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetFlexEOhpSinkFieldsAccepted (self, channel, direction):
        ...
        self.check_response(apiResponse, DenebApi.GetFlexEOhpSinkFieldsAccepted)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOtnOhpSourceApsChannels (self, channel, map_level, aps_channel_select, aps_value, aps_enable):
        ...
        self.check_response(apiResponse, DenebApi.SetOtnOhpSourceApsChannels)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnOhpSourceApsChannels (self, channel, map_level, aps_channel_select):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnOhpSourceApsChannels)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOtnOhpSourceTti (self, channel, field_level, map_level, tti_sapi, tti_dapi, tti_os, enable):
        ...
        self.check_response(apiResponse, DenebApi.SetOtnOhpSourceTti)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnOhpSourceTti (self, channel, field_level, map_level):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnOhpSourceTti)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnOhpSinkTtiAccepted (self, channel, field_level, map_level):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnOhpSinkTtiAccepted)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnOhpSinkTtiExpected (self, channel, field_level, map_level):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnOhpSinkTtiExpected)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOtnOhpSinkTtiExpected (self, channel, field_level, map_level, tti_sapi_expected, tti_dapi_expected, tti_os_expected, tti_sapi_expected_mask, tti_dapi_expected_mask, tti_os_expected_mask):
        ...
        self.check_response(apiResponse, DenebApi.SetOtnOhpSinkTtiExpected)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnOhpSinkPtExpected (self, channel, map_level):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnOhpSinkPtExpected)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOtnOhpSinkPtExpected (self, channel, map_level, payload_type_expected):
        ...
        self.check_response(apiResponse, DenebApi.SetOtnOhpSinkPtExpected)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnOhpSinkPtAccepted (self, channel, map_level):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnOhpSinkPtAccepted)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnOhpSinkApsChannels (self, channel, map_level, aps_channel_select):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnOhpSinkApsChannels)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOtnOhpSinkMsiExpected (self, channel, map_level, msi_expected, msi_expected_mask):
        ...
        self.check_response(apiResponse, DenebApi.SetOtnOhpSinkMsiExpected)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnOhpSinkMsiExpected (self, channel, map_level):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnOhpSinkMsiExpected)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnOhpSinkMsiAccepted (self, channel, map_level):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnOhpSinkMsiAccepted)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOtnOhpSourceMsi (self, channel, map_level, msi_value, msi_enable):
        ...
        self.check_response(apiResponse, DenebApi.SetOtnOhpSourceMsi)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnOhpSourceMsi (self, channel, map_level):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnOhpSourceMsi)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOtnOhpSourceCsf (self, channel, map_level, csf_mode, csf_override_value, csf_override_enable):
        ...
        self.check_response(apiResponse, DenebApi.SetOtnOhpSourceCsf)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnOhpSourceCsf (self, channel, map_level):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnOhpSourceCsf)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnOhpSinkFtflAccepted (self, channel, map_level):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnOhpSinkFtflAccepted)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def LoadOhaFw (self, data):
        ...
        self.check_response(apiResponse, DenebApi.LoadOhaFw)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOhaFw (self, ):
        ...
        apiResponse = {
             ...
             'Status' : (response[2] & 0xFF),
             'Info' : (response[3] & 0xFF),
             'srm_fw_ready' : (response[4] & 0xFF),
        }
        self.check_response(apiResponse, DenebApi.GetOhaFw)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOhaFw (self, action):
        ...
        self.check_response(apiResponse, DenebApi.SetOhaFw)
        self.add_api_exec_cb()
        return apiResponse

    def GetOhaFwVersion (self, ):
        #Default header
        header=ArgHeader()
        header.Length = 8
        header.Command = 0x262
        header.Tag = 0
        header.MaxResponse = 8
        header.Reserved = 0
        ...
        apiResponse = {
             ...
             'Status' : (response[2] & 0xFF),
             'Info' : (response[3] & 0xFF),
             'fw_version' : (response[4] & 0xFF)|((response[5]<<8) & (0xFF<<8))|((response[6]<<16) & (0xFF<<16))|((response[7]<<24) & (0xFF<<24)),
        }
        self.check_response(apiResponse, DenebApi.GetOhaFwVersion)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOhaGlobalConfig (self, sgmii_channel, sgmii_rate, lpbk_mode, rx_discard_on_address_mismatch, tx_mac_src_address, tx_mac_dst_address):
        ...
        self.check_response(apiResponse, DenebApi.SetOhaGlobalConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOhaGlobalConfig (self, sgmii_channel):
        ...
        self.check_response(apiResponse, DenebApi.GetOhaGlobalConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOhaGlobalStatus (self, sgmii_channel):
        ...
        self.check_response(apiResponse, DenebApi.GetOhaGlobalStatus)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOtnOhaConfig (self, channel, map_level, sgmii_channel, add_byte_select, add_byte_mask, add_mfas_align, drop_byte_select, drop_ohbu_length, port_enable):
        ...
        self.check_response(apiResponse, DenebApi.SetOtnOhaConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnOhaConfig (self, channel, map_level):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnOhaConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetFlexeOhaConfig (self, channel, sgmii_channel, drop_ohbu_length, add_pcs_mask, port_enable):
        ...
        self.check_response(apiResponse, DenebApi.SetFlexeOhaConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetFlexeOhaConfig (self, channel):
        ...
        self.check_response(apiResponse, DenebApi.GetFlexeOhaConfig)
        self.add_api_exec_cb()
        return apiResponse

    def SetFlexoOhaConfig (self, channel, config_target, sgmii_channel, add_byte_select, add_byte_mask, drop_byte_select, drop_ohbu_length, mfas_insertion_enable, port_enable):
        #Default header
        header=ArgHeader()
        header.Length = 136
        ...
        command_array[8] = channel>>0
        # assert: (x >= 0 && x <= 4)
        command_array[9] = config_target>>0
        # assert: (x >= 0 && x <= 3)
        command_array[10] = sgmii_channel>>0
        # assert: (x >= 0 && x <= 1)
        command_array[11] = add_byte_select[0]>>0
        ...
        command_array[50] = add_byte_select[39]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[51] = add_byte_mask[0]>>0
        command_array[52] = add_byte_mask[1]>>0
        command_array[53] = add_byte_mask[2]>>0
        command_array[54] = add_byte_mask[3]>>0
        command_array[55] = add_byte_mask[4]>>0
        command_array[56] = add_byte_mask[5]>>0
        command_array[57] = add_byte_mask[6]>>0
        command_array[58] = add_byte_mask[7]>>0
        command_array[59] = add_byte_mask[8]>>0
        command_array[60] = add_byte_mask[9]>>0
        command_array[61] = add_byte_mask[10]>>0
        command_array[62] = add_byte_mask[11]>>0
        command_array[63] = add_byte_mask[12]>>0
        command_array[64] = add_byte_mask[13]>>0
        command_array[65] = add_byte_mask[14]>>0
        command_array[66] = add_byte_mask[15]>>0
        command_array[67] = add_byte_mask[16]>>0
        command_array[68] = add_byte_mask[17]>>0
        command_array[69] = add_byte_mask[18]>>0
        command_array[70] = add_byte_mask[19]>>0
        command_array[71] = add_byte_mask[20]>>0
        command_array[72] = add_byte_mask[21]>>0
        command_array[73] = add_byte_mask[22]>>0
        command_array[74] = add_byte_mask[23]>>0
        command_array[75] = add_byte_mask[24]>>0
        command_array[76] = add_byte_mask[25]>>0
        command_array[77] = add_byte_mask[26]>>0
        command_array[78] = add_byte_mask[27]>>0
        command_array[79] = add_byte_mask[28]>>0
        command_array[80] = add_byte_mask[29]>>0
        command_array[81] = add_byte_mask[30]>>0
        command_array[82] = add_byte_mask[31]>>0
        command_array[83] = add_byte_mask[32]>>0
        command_array[84] = add_byte_mask[33]>>0
        command_array[85] = add_byte_mask[34]>>0
        command_array[86] = add_byte_mask[35]>>0
        command_array[87] = add_byte_mask[36]>>0
        command_array[88] = add_byte_mask[37]>>0
        command_array[89] = add_byte_mask[38]>>0
        command_array[90] = add_byte_mask[39]>>0
        command_array[91] = drop_byte_select[0]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[92] = drop_byte_select[1]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[93] = drop_byte_select[2]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[94] = drop_byte_select[3]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[95] = drop_byte_select[4]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[96] = drop_byte_select[5]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[97] = drop_byte_select[6]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[98] = drop_byte_select[7]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[99] = drop_byte_select[8]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[100] = drop_byte_select[9]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[101] = drop_byte_select[10]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[102] = drop_byte_select[11]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[103] = drop_byte_select[12]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[104] = drop_byte_select[13]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[105] = drop_byte_select[14]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[106] = drop_byte_select[15]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[107] = drop_byte_select[16]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[108] = drop_byte_select[17]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[109] = drop_byte_select[18]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[110] = drop_byte_select[19]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[111] = drop_byte_select[20]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[112] = drop_byte_select[21]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[113] = drop_byte_select[22]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[114] = drop_byte_select[23]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[115] = drop_byte_select[24]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[116] = drop_byte_select[25]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[117] = drop_byte_select[26]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[118] = drop_byte_select[27]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[119] = drop_byte_select[28]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[120] = drop_byte_select[29]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[121] = drop_byte_select[30]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[122] = drop_byte_select[31]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[123] = drop_byte_select[32]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[124] = drop_byte_select[33]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[125] = drop_byte_select[34]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[126] = drop_byte_select[35]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[127] = drop_byte_select[36]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[128] = drop_byte_select[37]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[129] = drop_byte_select[38]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[130] = drop_byte_select[39]>>0
        # assert: (x >= 1 && x <= 40)
        command_array[131] = drop_ohbu_length>>0
        command_array[132] = mfas_insertion_enable>>0
        # assert: (x >= 0 && x <= 1)
        command_array[133] = port_enable>>0
        # assert: (x >= 0 && x <= 1)
        ...
        self.check_response(apiResponse, DenebApi.SetFlexoOhaConfig)
        self.add_api_exec_cb()
        return apiResponse

    def GetFlexoOhaConfig (self, channel, config_target):
        #Default header
        header=ArgHeader()
        header.Length = 12
        ...
        self.check_response(apiResponse, DenebApi.GetFlexoOhaConfig)
        self.add_api_exec_cb()
        return apiResponse

    def GetCoreOfecTestPatternCheckerStatistics (self, ):
        #Default header
        header=ArgHeader()
        header.Length = 8
        ...
        self.check_response(apiResponse, DenebApi.GetCoreOfecTestPatternCheckerStatistics)
        self.add_api_exec_cb()
        return apiResponse

    def GetCoreOfecTestPatternCheckerConfig (self, ):
        #Default header
        header=ArgHeader()
        header.Length = 8
        ...
        self.check_response(apiResponse, DenebApi.GetCoreOfecTestPatternCheckerConfig)
        self.add_api_exec_cb()
        return apiResponse

    def GetCoreOfecTestPatternGeneratorConfig (self, ):
        #Default header
        header=ArgHeader()
        header.Length = 8
        ...
        self.check_response(apiResponse, DenebApi.GetCoreOfecTestPatternGeneratorConfig)
        self.add_api_exec_cb()
        return apiResponse

    def SetCoreOfecTestPatternCheckerConfig (self, signal_type, enable):
        #Default header
        header=ArgHeader()
        header.Length = 12
        header.Command = 0x2A2
        header.Tag = 0
        header.MaxResponse = 4
        header.Reserved = 0
        ...
        self.check_response(apiResponse, DenebApi.SetCoreOfecTestPatternCheckerConfig)
        self.add_api_exec_cb()
        return apiResponse

    def SetCoreOfecTestPatternGeneratorConfig (self, signal_type, enable):
        #Default header
        header=ArgHeader()
        header.Length = 12
        header.Command = 0x2A1
        header.Tag = 0
        header.MaxResponse = 4
        header.Reserved = 0
        ...
        self.check_response(apiResponse, DenebApi.SetCoreOfecTestPatternGeneratorConfig)
        self.add_api_exec_cb()
        return apiResponse

    def GetLineOfecFramedTestPatternCheckerConfig (self, ):
        #Default header
        header=ArgHeader()
        header.Length = 8
        ...
        self.check_response(apiResponse, DenebApi.GetLineOfecFramedTestPatternCheckerConfig)
        self.add_api_exec_cb()
        return apiResponse

    def GetLineOfecFramedTestPatternGeneratorConfig (self, ):
        #Default header
        header=ArgHeader()
        header.Length = 8
        ...
        apiResponse = {
             ...
             'prbs_seed' : [                          (response[8] & 0xFF)|((response[9]<<8) & (0xFF<<8))|((response[10]<<16) & (0xFF<<16))|((response[11]<<24) & (0xFF<<24)),
                          (response[12] & 0xFF)|((response[13]<<8) & (0xFF<<8))|((response[14]<<16) & (0xFF<<16))|((response[15]<<24) & (0xFF<<24)),
                          (response[16] & 0xFF)|((response[17]<<8) & (0xFF<<8))|((response[18]<<16) & (0xFF<<16))|((response[19]<<24) & (0xFF<<24)),
                          (response[20] & 0xFF)|((response[21]<<8) & (0xFF<<8))|((response[22]<<16) & (0xFF<<16))|((response[23]<<24) & (0xFF<<24)),
                          ],
             'enable' : (response[24] & 0xFF),
        }
        self.check_response(apiResponse, DenebApi.GetLineOfecFramedTestPatternGeneratorConfig)
        self.add_api_exec_cb()
        return apiResponse

    def SetLineOfecFramedTestPatternCheckerConfig (self, signal_type, enable):
        #Default header
        header=ArgHeader()
        header.Length = 12
        ...
        self.check_response(apiResponse, DenebApi.SetLineOfecFramedTestPatternCheckerConfig)
        self.add_api_exec_cb()
        return apiResponse

    def SetLineOfecFramedTestPatternGeneratorConfig (self, signal_type, prbs_seed, enable):
        #Default header
        header=ArgHeader()
        header.Length = 16
        ...
        command_array[8] = signal_type>>0
        # assert: (x >= 0 && x <= 6)
        command_array[9] = prbs_seed>>0
        command_array[10] = prbs_seed>>8
        command_array[11] = prbs_seed>>16
        command_array[12] = prbs_seed>>24
        # assert: (x <= 0x7FFFFFFF)
        command_array[13] = enable>>0
        # assert: (x >= 0 && x <= 1)
        ...
        self.check_response(apiResponse, DenebApi.SetLineOfecFramedTestPatternGeneratorConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetCoreCfecTestPatternCheckerStatistics (self, ):
        ...
        self.check_response(apiResponse, DenebApi.GetCoreCfecTestPatternCheckerStatistics)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetPcsTestPatternGeneratorConfig (self, channel, direction, pcs_signal_type, enable):
        ...
        self.check_response(apiResponse, DenebApi.SetPcsTestPatternGeneratorConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetPcsTestPatternGeneratorConfig (self, channel, direction):
        ...
        self.check_response(apiResponse, DenebApi.GetPcsTestPatternGeneratorConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetPcsTestPatternCheckerConfig (self, channel, direction, pcs_signal_type, enable):
        ...
        self.check_response(apiResponse, DenebApi.SetPcsTestPatternCheckerConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetPcsTestPatternCheckerConfig (self, channel, direction):
        ...
        self.check_response(apiResponse, DenebApi.GetPcsTestPatternCheckerConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetPcsTestPatternCheckerStatistics (self, channel, direction):
        ...
        self.check_response(apiResponse, DenebApi.GetPcsTestPatternCheckerStatistics)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetCoreCfecTestPatternCheckerConfig (self, signal_type, enable):
        ...
        self.check_response(apiResponse, DenebApi.SetCoreCfecTestPatternCheckerConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetCoreCfecTestPatternGeneratorConfig (self, signal_type, enable):
        ...
        self.check_response(apiResponse, DenebApi.SetCoreCfecTestPatternGeneratorConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetCoreCfecTestPatternCheckerConfig (self, ):
        ...
        self.check_response(apiResponse, DenebApi.GetCoreCfecTestPatternCheckerConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetCoreCfecTestPatternGeneratorConfig (self, ):
        ...
        self.check_response(apiResponse, DenebApi.GetCoreCfecTestPatternGeneratorConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetHostUnframedTestPatternGeneratorConfig (self, dual, prbs_type_1, prbs_type_2, enable):
        ...
        self.check_response(apiResponse, DenebApi.SetHostUnframedTestPatternGeneratorConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetHostUnframedTestPatternGeneratorConfig (self, dual):
        ...
        self.check_response(apiResponse, DenebApi.GetHostUnframedTestPatternGeneratorConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetHostUnframedTestPatternCheckerConfig (self, dual, prbs_type_1, prbs_type_2, enable):
        ...
        self.check_response(apiResponse, DenebApi.SetHostUnframedTestPatternCheckerConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetHostUnframedTestPatternCheckerConfig (self, dual):
        ...
        self.check_response(apiResponse, DenebApi.GetHostUnframedTestPatternCheckerConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOtuServerTestPatternGeneratorConfig (self, channel, signal_type, enable):
        ...
        self.check_response(apiResponse, DenebApi.SetOtuServerTestPatternGeneratorConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOtuServerTestPatternCheckerConfig (self, channel, signal_type, enable):
        ...
        self.check_response(apiResponse, DenebApi.SetOtuServerTestPatternCheckerConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtuServerTestPatternGeneratorConfig (self, channel):
        ...
        self.check_response(apiResponse, DenebApi.GetOtuServerTestPatternGeneratorConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtuServerTestPatternCheckerConfig (self, channel):
        ...
        self.check_response(apiResponse, DenebApi.GetOtuServerTestPatternCheckerConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOtuClientTestPatternGeneratorConfig (self, channel, direction, signal_type, keep_incoming_fs, enable):
        ...
        self.check_response(apiResponse, DenebApi.SetOtuClientTestPatternGeneratorConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOtuClientTestPatternCheckerConfig (self, channel, direction, signal_type, enable):
        ...
        self.check_response(apiResponse, DenebApi.SetOtuClientTestPatternCheckerConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtuClientTestPatternGeneratorConfig (self, channel, direction):
        ...
        self.check_response(apiResponse, DenebApi.GetOtuClientTestPatternGeneratorConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtuClientTestPatternCheckerConfig (self, channel, direction):
        ...
        self.check_response(apiResponse, DenebApi.GetOtuClientTestPatternCheckerConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtuTestPatternCheckerStatistics (self, channel, direction):
        ...
        self.check_response(apiResponse, DenebApi.GetOtuTestPatternCheckerStatistics)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetHostUnframedStandardPatternGeneratorConfig (self, dual, standard_type_1, standard_type_2, enable):
        ...
        self.check_response(apiResponse, DenebApi.SetHostUnframedStandardPatternGeneratorConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetHostUnframedStandardPatternGeneratorConfig (self, dual):
        ...
        self.check_response(apiResponse, DenebApi.GetHostUnframedStandardPatternGeneratorConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetHostUnframedCustomPatternGeneratorConfig (self, dual, fixed_pattern_1, fixed_pattern_2, enable):
        ...
        self.check_response(apiResponse, DenebApi.SetHostUnframedCustomPatternGeneratorConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetHostUnframedCustomPatternGeneratorConfig (self, dual):
        ...
        self.check_response(apiResponse, DenebApi.GetHostUnframedCustomPatternGeneratorConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetHostUnframedCustomPatternCheckerConfig (self, dual, fixed_pattern_1, fixed_pattern_2, enable):
        ...
        self.check_response(apiResponse, DenebApi.SetHostUnframedCustomPatternCheckerConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetHostUnframedCustomPatternCheckerConfig (self, dual):
        ...
        self.check_response(apiResponse, DenebApi.GetHostUnframedCustomPatternCheckerConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetHostUnframedTestPatternCheckerStatistics (self, lane):
        ...
        self.check_response(apiResponse, DenebApi.GetHostUnframedTestPatternCheckerStatistics)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetIngressSmInformation (self, ):
        ...
        self.check_response(apiResponse, DenebApi.GetIngressSmInformation)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetFawErrorStatistics (self, ):
        ...
        self.check_response(apiResponse, DenebApi.GetFawErrorStatistics)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetErrorCorrectionStatistics (self, channel, direction):
        ...
        self.check_response(apiResponse, DenebApi.GetErrorCorrectionStatistics)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetPcsErrorStatistics (self, channel, direction):
        ...
        self.check_response(apiResponse, DenebApi.GetPcsErrorStatistics)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetFawErrorStatisticsOccurrenceInfo (self, ):
        ...
        self.check_response(apiResponse, DenebApi.GetFawErrorStatisticsOccurrenceInfo)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetPcsErrorStatisticsOccurrenceInfo (self, channel, direction):
        ...
        self.check_response(apiResponse, DenebApi.GetPcsErrorStatisticsOccurrenceInfo)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetErrorCorrectionStatisticsOccurrenceInfo (self, channel, direction):
        ...
        self.check_response(apiResponse, DenebApi.GetErrorCorrectionStatisticsOccurrenceInfo)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetEthernetIdleTrafficTimer (self, channel):
        ...
        self.check_response(apiResponse, DenebApi.GetEthernetIdleTrafficTimer)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetEthernetIdleTrafficTimer (self, channel, timer_value):
        ...
        self.check_response(apiResponse, DenebApi.SetEthernetIdleTrafficTimer)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetEthernetBjAmConfig (self, channel):
        ...
        self.check_response(apiResponse, DenebApi.GetEthernetBjAmConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetEthernetBjAmConfig (self, channel, four_lane_pmd):
        ...
        self.check_response(apiResponse, DenebApi.SetEthernetBjAmConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetEthernetMaxFrameLength (self, channel, direction, max_packet_length, max_broad_multi_length, max_jabber_length):
        ...
        self.check_response(apiResponse, DenebApi.SetEthernetMaxFrameLength)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetEthernetMaxFrameLength (self, channel, direction):
        ...
        self.check_response(apiResponse, DenebApi.GetEthernetMaxFrameLength)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetEthernetCounters (self, channel, direction):
        ...
        self.check_response(apiResponse, DenebApi.GetEthernetCounters)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def ReadEthernetPacketTrap (self, channel, direction, clean_memory):
        ...
        self.check_response(apiResponse, DenebApi.ReadEthernetPacketTrap)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetEthernetPacketTrapConfig (self, channel, direction):
        ...
        self.check_response(apiResponse, DenebApi.GetEthernetPacketTrapConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetEthernetPacketTrapConfig (self, channel, direction, mac_source_address, mac_source_address_mask, mac_destination_address, mac_destination_address_mask, mac_ethertype, mac_ethertype_mask):
        ...
        self.check_response(apiResponse, DenebApi.SetEthernetPacketTrapConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnOhpAlarms (self, channel, map_level):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnOhpAlarms)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnAlarms (self, channel, direction):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnAlarms)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetOtnGmpAlarms (self, channel):
        ...
        self.check_response(apiResponse, DenebApi.GetOtnGmpAlarms)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetEthernetAlarms (self, channel, direction):
        ...
        apiResponse = {
             ...
             'pcs_hi_ber' : (response[7] & 0xFF),
             'pcs_hi_ser' : (response[8] & 0xFF),
             'pcs_dLRC' : (response[9] & 0xFF),
             'pcs257_am_lock_n' : (response[10] & 0xFF),
             'pcs66_block_lock_n' : (response[11] & 0xFF)|((response[12]<<8) & (0xFF<<8))|((response[13]<<16) & (0xFF<<16))|((response[14]<<24) & (0xFF<<24)),
             'pcs66_am_lock_n' : (response[15] & 0xFF)|((response[16]<<8) & (0xFF<<8))|((response[17]<<16) & (0xFF<<16))|((response[18]<<24) & (0xFF<<24)),
        }
        self.check_response(apiResponse, DenebApi.GetEthernetAlarms)
        self.add_api_exec_cb()
        return apiResponse

    def GetFlexOAlarms (self, direction, channel):
        #Default header
        header=ArgHeader()
        header.Length = 12
        ...
        self.check_response(apiResponse, DenebApi.GetFlexOAlarms)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetFlexEAlarms (self, channel, direction):
        ...
        self.check_response(apiResponse, DenebApi.GetFlexEAlarms)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetTemperature (self, sensor_id_0, sensor_id_1, sensor_id_2, sensor_id_3):
        ...
        self.check_response(apiResponse, DenebApi.GetTemperature)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def ReadLinePowerSupply (self, lane):
        ...
        self.check_response(apiResponse, DenebApi.ReadLinePowerSupply)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def ReleaseDiagnosticUnit (self, ):
        ...
        self.check_response(apiResponse, DenebApi.ReleaseDiagnosticUnit)
        self.add_api_exec_cb()
        return apiResponse

    def GetDuFcrCapture (self, load_new_capture):
        #Default header
        header=ArgHeader()
        header.Length = 12
        header.Command = 0x273
        header.Tag = 0
        header.MaxResponse = 328
        header.Reserved = 0
        ...
        command_array[6] = header.Tag>>0
        command_array[7] = header.Reserved>>0
        command_array[8] = load_new_capture>>0
        # assert: (x >= 0 && x <= 1)
        ...
        apiResponse = {
             ...
             'remaining_calls' : (response[324] & 0xFF)|((response[325]<<8) & (0xFF<<8)),
        }
        self.check_response(apiResponse, DenebApi.GetDuFcrCapture)
        self.add_api_exec_cb()
        return apiResponse

    def GetDuAdcCapture (self, load_new_capture):
        #Default header
        header=ArgHeader()
        header.Length = 12
        header.Command = 0x272
        header.Tag = 0
        header.MaxResponse = 488
        header.Reserved = 0
        ...
        apiResponse = {
             ...
             'remaining_calls' : (response[484] & 0xFF)|((response[485]<<8) & (0xFF<<8)),
        }
        self.check_response(apiResponse, DenebApi.GetDuAdcCapture)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetOpticalMonitorsConfig (self, action, lut, arg_array):
        ...
        self.check_response(apiResponse, DenebApi.SetOpticalMonitorsConfig)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def ControlAvs (self, Ctrl, Vstep, CurrentV, AVSAnalysisMode, AVSRate, Prv, Reserved):
        ...
        self.check_response(apiResponse, DenebApi.ControlAvs)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def SetMonitorClocks (self, enable_ltx_monclk, reserved):
        ...
        self.check_response(apiResponse, DenebApi.SetMonitorClocks)
        self.add_api_exec_cb()
        return apiResponse
    ...
    def GetMonitorClocks (self, ):
        ...
        self.check_response(apiResponse, DenebApi.GetMonitorClocks)
        self.add_api_exec_cb()
        return apiResponse
